						...
						<div class="row">
							<div class="col-12 col-lg-12">
								...
								<div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form-control" placeholder="Digite seu nome do usuário" name="nome" required>
                                    </div>
                                </div>						
							</div>
							<div class="col-12 col-lg-12">
							...
							<div class="col-12 col-lg-12" style="text-align:right;">
								<button name="acesso" value="1"  type="submit" class="btn btn-primary btn-lg">Entrar</button>
							</div>
						</div>
					</form>
				</div>	
