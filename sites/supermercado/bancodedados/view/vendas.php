...
<head>
	...
	<title>Gestão Supermercado - Vendas
						...
						<div class="row">
							...
							<div class="col-12 col-lg-2">
								<div class="card">
									...
									<div class="card-body">
										<input onkeyup="precoContas()" onchange="precoContas()" type="number" min="0" class="form-control" id="quantidade" name="quantidade" value="<?Php echo isset($_GET['quantidadeEditar']) ? $_GET['quantidadeEditar'] : '' ?>" min="0" placeholder="Digite a quantidade da compra" required>
									</div>
								</div>
							</div>
							<div class="col-12 col-lg-3">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">Preço unitário:</h5>
									</div>
									<div class="card-body">
										<input onkeyup="precoContas()" onchange="precoContas()" type="number" step="0.01" class="form-control" placeholder="Valor unitário" id="preco" name="preco" value="<?Php echo isset($_GET['precoEditar']) ? number_format($_GET['precoEditar'],2) : '' ?>" min="0" readonly>
									</div>
								</div>
							</div>
							<div class="col-12 col-lg-3">
							...
							<div class="col-12 col-lg-3">
								<div class="card">
									...
									<div class="card-body">
										<input type="date" class="form-control" name="diaPagamento" value="<?Php echo isset($_GET['diaPagamentoEditar']) ? $_GET['diaPagamentoEditar'] : date('Y-m-d') ?>" readonly>
									</div>
								</div>
							</div>
