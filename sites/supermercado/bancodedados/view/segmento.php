			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					...
					<form action="../controller/registrar.php" method="GET">
						<div class="row">
							<h1>Segmento <span id="mensagem" onmouseover="mostrarInformacoes('Cadastre os segmentos do super mercado.<br>Ex. Mercearia, Bebidas, Bazar etc...')" onmouseout="tirarInformacoes()" style="background-color: red; padding: 2px 10px; border-radius: 50%;">?</span></h1>
					...
					<form action="#" method="get" style="margin-top: 20px; margin-bottom: 20px;">
						...
						<?php
							...
							if($procura == ''){
								...
								$sql = "SELECT * FROM segmento WHERE nome LIKE '%".$procura."%'";
							}
						...
						<table class="table">
							...
							<?php foreach($dados as $row){ ?>
								<?php $segmento = new Segmento($row['codigo'], $row['nome'])?>
										<tr>
											...
											<td>
												<?php echo botaoTabelaDeletar($segmento->getCodigo())?>
											</td>
										</tr>
									<?php } ?>
							</tbody>
