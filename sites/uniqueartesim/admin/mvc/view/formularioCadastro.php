...
<section id="acao">
    <form action="./mvc/controller/cadastro.php" method="post">
        ...
        <div>
            ...
            <input type="text" name="usuario" id="usuario" placeholder="Digite o usuário" value='<?php echo $usuario;?>' required <?php echo $_GET['acao'] == "editar" || $_GET['acao'] == "excluir" ? "disabled" : "";?>>
        </div>
        <div>
