    ...
    <table id="tableEmpressa">
        <thead>
            ...
            <tr>
                ...
                <td><input type="text" name="col6" id="col6" class="colInput"></td>
                <td><input type="text" name="col7" id="col7" class="colInput"></td>
            </tr>
        </thead>
        <tbody>
            <?php
                ...
                if(!$busca){
                    ...
                    while($reg = $busca->fetch_object()){
                        ...
                        <td>$reg->instagram</td>
                        <td>$reg->mapa</td>
                        <td><img src='../assets/imagens/logo/$reg->logo' alt='$reg->nome'></td>
                        <td>$reg->caminho</td>
